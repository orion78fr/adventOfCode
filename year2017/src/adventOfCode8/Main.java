...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for (String line : in) {
            ...
            String ifReg = split[4];
            ComparisonType ifType = ComparisonType.of(split[5]);
            long ifVal = Long.parseLong(split[6]);

            if (compare(m.getOrDefault(ifReg, 0L), ifType, ifVal)) {
                m.put(reg, m.getOrDefault(reg, 0L) + (op.equals("inc") ? val : -val));
        ...
        System.out.println(m.values().stream().max(Comparator.naturalOrder()).get());
        System.out.println(max);
    }

    private static boolean compare(Long orDefault, ComparisonType ifType, long ifVal) {
        switch (ifType) {
            case EQUAL:
                return orDefault == ifVal;
            case DIFFERENT:
                return orDefault != ifVal;
            case LESS:
                return orDefault < ifVal;
    ...
    private enum ComparisonType {
        ...
        public static ComparisonType of(String str) {
